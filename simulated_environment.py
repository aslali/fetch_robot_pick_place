...
class SHSCPackaging:
    ...
    def __init__(self, pattern, fast_run=False):
        ...
        self.pattern_col = {1: [], 2: [], 3: [], 4: [], 5: []}
        self.creat_pattern_colors(pattern)
    ...
    def creat_env(self):
        ...
        for i in range(5):
            ...
            self.canvas.create_text((self.w1b_x0[i] + self.boxes_width // 2, self.w1b_y0[i] + self.boxes_width // 2),
                                    text=str(i + 1))
