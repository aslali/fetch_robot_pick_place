...
class HeadControl(object):
    ...
    def head_sweep(self, pan_pos):
        self.move_head(pan_pos, 0.0, rospy.Time(1))
        if s:
            s.send(",".join([str(d) for d in list(self.get_pose())]))
...
if __name__ == '__main__':
    ...
    # head_control.look_at(0.387584455697,0,0.765846753992)
    head_control.move_head(1, 0.3)
    # time.sleep(3)
