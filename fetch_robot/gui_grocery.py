...
class ImageGUI(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.label_objs.setGeometry(875, 5, 380, 200)
        self.label_objs.setText("Grocery List:\n")

        button_context = QtWidgets.QPushButton("Learn Context", self)
        button_context.setGeometry(20, 25, 180, 40)
        button_get = QtWidgets.QPushButton("Get Grocery List", self)
        button_get.setGeometry(20, 75, 180, 40)
        button_upload = QtWidgets.QPushButton("Upload Grocery List", self)
